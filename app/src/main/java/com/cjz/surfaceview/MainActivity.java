...
public class MainActivity extends Activity implements
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        try {
            ...
            Uri uri = Uri.parse("http://vfx.mtime.cn/Video/2019/03/19/mp4/190319222227698228.mp4");
            try {
    ...
    public void click(View view) {
        if (mediaplayer != null && mediaplayer.isPlaying()) {
            ...
            mediaplayer.start();
            play.setImageResource(android.R.drawable.ic_media_pause);
            Toast.makeText(this, "http://vfx.mtime.cn/Video/2019/03/19/mp4/190319222227698228.mp4", Toast.LENGTH_SHORT).show();
        }
    }
    //进度发生变化时触发
    @Override
